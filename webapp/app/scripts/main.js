        ...
        $.getJSON(host + '/rail/view/' + searchName)
            ...
            L.geoJson(data, {
                pointToLayer: function (feature, latlng) {
                    ...
                    var htmlIcon = L.divIcon({ classname: 'info', iconSize: new L.Point(50, 50), html: '<textarea rows="4" cols="50">At w3schools.com you will learn how to make a website. ' +
                                             'We offer free tutorials in all web development technologies. ' +
                                             '</textarea> <img src="../images/marker-icon.png" alt="" align="right">' });
